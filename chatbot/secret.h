#ifndef SECRET
const char ssid[] = "Akin"; // Vul hier je Wi-Fi ssid in (niet belangrijk voor oplevering)
const char pass[] = "020319848"; // Vul hier je Wi-Fi wachtwoord in (niet belangrijk voor oplevering)

const char *MQTT_HOST = "netwerkenbasis.com";
const int MQTT_PORT = 8883; // Voer hier de MQTT-broker poort in op de aangegeven plek
const char *MQTT_CLIENT_ID = "BOT-1060024"; // Voer hier je leerlingnummer in op de aangegeven plek
